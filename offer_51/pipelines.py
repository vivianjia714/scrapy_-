...
#        sql = """insert ignore into t_uk(title, school_url, IELTS_grade, hotmajor,Timerank,QSrank) values(%s, %s, %s, %s,%s,%s)"""
        sql = """insert ignore into t_sg(title, school_url, IELTS_grade, hotmajor,Timerank,QSrank) values(%s, %s, %s, %s,%s,%s)"""
        param = (item['title'], item['school_url'], item['IELTS_grade'], item['hotmajor'],item['Timerank'],item['QSrank'])
